...
int Program(int argc, char* argv[])
{
	...
	const int N = 32;
	// Calculate how much memory would be copied over host to devices.
	...
	// Create buffers in device's memory.
	...
	// Send data in memory from host to device over buffers.
	...
	// Start - Additional code for checking kernel build errors.
	size_t len;
	char buffer[2048];
	...
	// Create grid with only global size 1 x globalWorkSize (N)
